...
fun AppNavigationBar(navController: NavController) {
    BottomNavigation(
        ...
        BottomNavigationItem(
            icon = { Icon(Icons.Filled.ShoppingCart, contentDescription = "User Generated Recipes") },
            selected = currentRoute(navController) == "user generated recipes",
            onClick = { navController.navigate("user generated recipes") }
        )
        BottomNavigationItem(

...
public class S3Controller {
	...
	public ResultResponse uploadRecipe(@RequestParam("file") MultipartFile file) {
		if(file != null)
			return s3Service.uploadRecipe(file);
		return null;
	}
	...
	@DeleteMapping("/delete-recipe/{file}")
	public ResultResponse deleteRecipe(@PathVariable("file") String fileName) {
		return s3Service.deleteRecipe(fileName);
	}
